...
if __name__ == "__main__":
    ...
    # Choose the TTS engine: 'deepgram' or 'coqui'
    tts_engine = 'coqui'  # You can change this to 'deepgram' to use DeepGram
    ...
    if tts_engine == 'deepgram':
        ...
        raise ValueError("Invalid TTS engine. Choose 'deepgram' or 'coqui'.")
